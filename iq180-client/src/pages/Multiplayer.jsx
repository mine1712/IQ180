                            ...
                            <div className="enter-private-container">
                                ...
                                <div className="input-container">
                                    ...
                                    <button
                                        className="set-name-button"
                                        onClick={() =>
                                            handleRoomSelection(privateRoomCode)
                                        }
                                    >
                                        Enter
                                    </button>
                ...
                {currentMultiplayerScreen == "gamescreen" && (
                    <div className="gamescreen-container">
                        ...
                        <div className="content-container">
                            <div className="target-time-container">
                                ...
                                <div className="multiplayer-time-container">
                                    <span>
                                        Time:{" "}
